...
def addQuestion():
	...
	if not CURRENT_USER:
		...
		if user[2] == "ADMIN":
			...
			print("You don't have access to add questions. Only admins are allowed to add questions.")
...
def about():
	print('''\\n----------------------------ABOUT US-------------------------------\n
This project has been created by Pranab Kumar Moharna as a part of final test of Python module of the Python-Django
Developer program of Edyoda Digital University''')
